...
class MainActivity : AppCompatActivity() {
    ...
    // Registrando um contrato para obter o resultado da atividade de captura
    private val captureActivityResult = registerForActivityResult(
        ...
        if (result.resultCode == RESULT_OK) {
            ...
            //Obs: tentei capturar como stream ou bytestream e nao consegui
        ...
        when (requestCode) {
            REQUEST_CAMERA_PERMISSION -> {
                if ((grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED)) {
                    ...
                    exibirToast(this, "Permissão de câmera negada")
                }
                return
            }
            else -> {
